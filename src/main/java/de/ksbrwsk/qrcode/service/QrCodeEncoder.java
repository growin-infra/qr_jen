...
public class QrCodeEncoder {
    ...
    private QrCodeProcessingResult generateImageAsBase64(String textToBeEncoded) {
        ...
        try {
            ...
            log.info("tmpdir["+getTmpdir()+"]");
//            File myFile = File.createTempFile(fileName, "." + fileType);
            File myFile = new File(getTmpdir() + File.separator + fileName + "." + fileType);
//            File myFile = File.createTempFile(fileName, "." + fileType, new File(getTmpdir()));
